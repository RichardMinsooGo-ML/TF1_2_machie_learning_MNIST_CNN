...
# Cross Entropy를 비용함수(cost function)으로 정의하고, RMSPropOptimizer를 이용해서 비용 함수를 최소화합니다.
...
with tf.Session() as sess:
    ...
    for i in range(N_EPISODES):
        ...
        if (i+1) % 100 == 0:
            ...
            print("Epoch: %6d, Training Accuracy: %2.6f, cost: %2.6f" % (i+1, train_accuracy, cost_print))
