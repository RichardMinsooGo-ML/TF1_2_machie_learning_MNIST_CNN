...
_LAY01_m = tf.nn.relu(tf.matmul(X, W01_m))
LAY01_m = tf.nn.dropout(_LAY01_m, keep_prob)
_LAY02_m = tf.nn.relu(tf.matmul(LAY01_m, W02_m))
LAY02_m = tf.nn.dropout(_LAY02_m, keep_prob)
Pred_m = tf.matmul(LAY02_m, W_output)
