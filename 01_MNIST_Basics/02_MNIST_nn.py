...
W01_m = tf.Variable(tf.random_normal([N_Input, H_SIZE_01]))
B01_m = tf.Variable(tf.random_normal([H_SIZE_01]))

W02_m = tf.Variable(tf.random_normal([H_SIZE_01, H_SIZE_02]))
B02_m = tf.Variable(tf.random_normal([H_SIZE_02]))

W_output = tf.Variable(tf.random_normal([H_SIZE_02, N_Classes]))
